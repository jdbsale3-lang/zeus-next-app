...
export interface GenerationTileProps {
  ...
  /** Message shown when `state="failed"`. */
        ...
        <GenerationDetailModal
          ...
          trigger={
            <button
              ...
              className="absolute inset-0 z-[1] cursor-pointer focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-q-border-focus"
              onFocus={onFocus}
              onBlur={onBlur}
            />
          }
